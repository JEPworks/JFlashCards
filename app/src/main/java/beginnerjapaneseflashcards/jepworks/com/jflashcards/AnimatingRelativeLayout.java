...
public class AnimatingRelativeLayout extends RelativeLayout
{
    ...
    {
        inAnimation = (Animation) AnimationUtils.loadAnimation(context, R.anim.from_middle);
        outAnimation = (Animation) AnimationUtils.loadAnimation(context, R.anim.to_middle);
